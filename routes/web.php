...
Route::prefix('ofertas')->group(function () {
    ...
    Route::get('/create', [OfertaController::class, 'create'])->middleware(['auth','cliente'])->name('ofertas.create');
    Route::post('/store', [OfertaController::class, 'store'])->middleware(['auth','cliente'])->name('ofertas.store');
