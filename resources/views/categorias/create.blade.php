...
<div class="container-fluid">
    ...
    <h1 class="text-center">Cadastrar Categoria</h1><br>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('categorias.store') }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="nomecategoria" class="m-2 textoAzul3">Nome da Categoria</label>
                        <input type="text" id="nomecategoria" class="w-auto form-control w-sm-auto" placeholder="" name="nomecategoria" required>
                    </div>
                </div>
