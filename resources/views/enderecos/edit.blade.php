...
@section('title', 'Editar Endereços')
...
<div class="container-fluid">
    ...
    <h1>Editar Endereço</h1><br>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('enderecos.update', $Endereco->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="cep" class="m-2 textoAzul3">CEP</label>
                        <input value="{{$Endereco->cep}}" type="text" id="cep" class="w-auto form-control w-sm-auto" name="cep" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="nomedarua" class="m-2 textoAzul3">Rua</label>
                        <input value="{{$Endereco->nomedarua}}" type="text" id="nomedarua" class="w-auto form-control w-sm-auto" name="nomedarua" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="numero" class="m-2 textoAzul3">Número</label>
                        <input value="{{$Endereco->numero}}" type="text" id="numero" class="w-auto form-control w-sm-auto" name="numero" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="bairro" class="m-2 textoAzul3">Bairro</label>
                        <input value="{{$Endereco->bairro}}" type="text" id="bairro" class="w-auto form-control w-sm-auto" name="bairro" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="complemento" class="m-2 textoAzul3">Complemento</label>
                        <input value="{{$Endereco->complemento}}" type="text" id="complemento" class="w-auto form-control w-sm-auto" name="complemento" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="cidade" class="m-2 textoAzul3">Cidade</label>
                        <input value="{{$Endereco->cidade}}" type="text" id="cidade" class="w-auto form-control w-sm-auto" name="cidade" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="estado" class="m-2 textoAzul3">Estado</label>
                        <input value="{{$Endereco->estado}}" type="text" id="estado" class="w-auto form-control w-sm-auto" name="estado" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="pontodereferencia" class="m-2 textoAzul3">Ponto de Referência</label>
                        <input value="{{$Endereco->pontodereferencia}}" type="text" id="pontodereferencia" class="w-auto form-control w-sm-auto" name="pontodereferencia" required>
                    </div>
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <select name="usuario_id" id="usuario_id" class="w-auto form-control w-sm-auto" required>
                            ...
                            <option value="{{ $usuario->id }}" {{ $Endereco->usuario_id == $usuario->id ? 'selected' : '' }}>
                                {{ $usuario->name}}
                            </option>
                            @endforeach
                        </select>
