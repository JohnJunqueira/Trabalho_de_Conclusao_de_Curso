...
<div class="container-fluid">
    <div class="ms-5 text-start badge text-wrap sinalizador">
        ...
        </svg> Cadastrar Serviço
    </div>

    <h1>Cadastrar Serviço</h1><br>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('servicos.store') }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf
                ...
                <div class="row m-2">
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input type="number" id="tempoexperiencia" class="w-auto form-control w-sm-auto" placeholder="em anos" name="tempoexperiencia" required>
                    </div>
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input type="text" id="valormedio" class="w-auto form-control w-sm-auto" placeholder="" name="valormedio" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="formadetrabalho" class="m-2 textoAzul3">Forma de Trabalho</label>
                        <input type="text" id="formadetrabalho" class="w-auto form-control w-sm-auto" placeholder="" name="formadetrabalho" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="formadepagamento" class="m-2 textoAzul3">Forma de Pagamento</label>
                        <input type="text" id="formadepagamento" class="w-auto form-control w-sm-auto" placeholder="" name="formadepagamento" required>
                    </div>

                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="agendadisponivel" class="m-2 textoAzul3">Agenda Disponível</label>
                        <input type="text" id="agendadisponivel" class="w-auto form-control w-sm-auto" placeholder="" name="agendadisponivel" required>
                    </div>
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <input type="text" id="portfolio" class="w-auto form-control w-sm-auto" placeholder="" name="portfolio" required>
                    </div>
