...
<div class="container-fluid">
    ...
    <h1 class="text-center">Editar Divisão</h1><br>

    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
        <div class="row d-flex justify-content-around ">
            <form action="{{ route('divisoes.update', $Divisao->id) }}" method="POST" class="col-12 m-0 p-0 formulario">
                @csrf

                <div class="row m-2">
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        <label for="nomedivisoes" class="m-2 textoAzul3">Nome da Divisao</label>
                        <input value="{{$Divisao->nomedivisoes}}" type="text" id="nomedivisoes" class="w-auto form-control w-sm-auto" name="nomedivisoes" required>
                    </div>
                    ...
                    <div class="col col-lg-3 col-md-4 col-sm-auto m-lg-4 m-md-4 m-sm-0">
                        ...
                        <select name="categoria_id" id="categoria_id" class="w-auto form-control w-sm-auto" required>
                            ...
                            <option value="{{ $categoria->id }}" {{ $Divisao->categoria_id == $categoria->id ? 'selected' : '' }}>
                ...
                <div class="col-lg-12" style="text-align:right">
                    <a href="{{ route ('divisoes.index') }}" class="btn btn-secondary me-5 mb-5" style="color: #fff;">Voltar</a>
