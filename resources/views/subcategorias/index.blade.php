...
<div class="container-fluid">
    ...
    <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
            ...
            <table class="table cabecalho-itens text-center p-2" id="conteudo-itens-lado-direito">
                ...
                <tbody class="conteudo-itens">
                    <tr>
                        ...
                        <td>{{$subcategoria->acessarCategoria->nomecategoria}}</td>

                        <td>
                            <div class="col" id="meio">
                                <form action="{{route('subcategorias.edit', ['id' => $subcategoria->id])}}" method="get">
                                    @csrf
                        ...
                        <td>
                            <div class="col" id="meio">
                                <form id="formExcluir" action="{{ route('subcategorias.delete', ['id' => $subcategoria->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="col-lg-12 me-3" style="text-align:right">
            <form action="{{route('subcategorias.create')}}" method="get">
                @csrf
...
<script>
    function confirmarExclusao() {
        if (confirm("Tem certeza que deseja excluir essa SubCategoria?")) {
